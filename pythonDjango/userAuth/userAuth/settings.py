...
SECRET_KEY = 'u8x!2%+5++lfnv4d-!z@mh0gk^t4*s8cu0u@vtom-j6994prfl'
...
##########
# You should set it before creating any migrations or running manage.py migrate for the first time.
...
###################################3
# Customize settings for user.auth module
